...
// dogecorn with Governance.
contract DogeCorn is BEP20('DogeCorn', 'DogeCorn') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying dogecorn (not scaled);
